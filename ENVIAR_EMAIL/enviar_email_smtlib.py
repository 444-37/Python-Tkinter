...
#Imagen GMAIL
imagen_gmail=Image.open("sol de mayo.jpeg")
...
values=["danielprogramacion53@gmail.com", "estudiof443@gmail.com", "programacionsabattini@gmail.com", "fjcoronati@gmail.com", "lafortaleza246@gmail.com"])
...
"------------ENVIO DE CORREO------------"
def enviar_email():
    remitente = "antnella.cattaneo.m@gmail.com"
    #Estrutura de email
    email = EmailMessage()
    ...
    smtp.login(remitente, "wvnqtepzjlivnpdm")
